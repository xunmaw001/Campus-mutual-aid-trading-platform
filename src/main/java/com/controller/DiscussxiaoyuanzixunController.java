...
public class DiscussxiaoyuanzixunController {
    ...
    public R save(@RequestBody DiscussxiaoyuanzixunEntity discussxiaoyuanzixun, HttpServletRequest request){
    	discussxiaoyuanzixun.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<DiscussxiaoyuanzixunEntity> wrapper = new EntityWrapper<DiscussxiaoyuanzixunEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = discussxiaoyuanzixunService.selectCount(wrapper);
